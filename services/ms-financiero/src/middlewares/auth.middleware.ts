 ...
 * aunque la peticion venga del gateway y el gateway ya lo haya verificado. No es
 * redundancia: el dia que alguien alcance la red interna sin pasar por el
 * gateway, esta es la unica comprobacion que queda en pie.
 *
 * Y verificar incluye la revocacion, que se lee de la copia en memoria porque la
 * lista es de otro servicio. La diferencia observable es la ventana de refresco:
 * un logout tarda hasta 15 segundos en surtir efecto aqui. Ver `docs/adr/0008`.
 */
