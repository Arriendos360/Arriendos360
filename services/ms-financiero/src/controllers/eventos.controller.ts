 ...
 * en `packages/shared`, para que ningun consumidor tenga que reescribirla ni
 * pueda desviarse de ella. Lo unico que este archivo aporta es el adaptador a
 * Express, y es identico al de ms-inmuebles porque tiene que serlo.
 *
 ...
 * servicio, que `interno.routes.ts` exige para todo el router. Sin ella
 * cualquiera con acceso al puerto podria facturarle un canon a quien quisiera
 * inventandose un sobre.
 */
 ...
 *   tres casos el productor puede marcarlo entregado y olvidarse. `ContratoFinalizado`
 *   cae en el tercero.
