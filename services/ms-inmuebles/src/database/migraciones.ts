/**
 * Aplicador de migraciones de MS-Inmuebles.
 *
 ...
 *
 * 1. Los `.sql` viven en `database/inmuebles/`, en la raiz del monorepo, que es
 *    donde CLAUDE.md ubica las migraciones: una carpeta por esquema. Salieron
 *    de `database/dominio/`, que sigue siendo provisional para lo que queda.
 *
 * 2. La tabla de control tambien vive en el esquema `inmuebles`, para que este
